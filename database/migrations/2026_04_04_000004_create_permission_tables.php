 ...
 *
 * This is a copy of the vendor migration customised for our table naming
 * and team-less setup. We ship it in our own migrations folder so the
 * order relative to the PostGIS / user-role fixes is deterministic.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception(
                'Error: config/permission.php not found. Run [php artisan vendor:publish --provider="Spatie\Permission\PermissionServiceProvider"] first.'
            );
        }
