 ...
 * `VaccineCatalog`, `FoodBrand`, `Specialty`, `FoodAllergy`, `DietaryRestriction` e
 * `Breed`. Generico: usa `$model->getTable()` para incrementar so o contador da
 * tabela que mudou, nunca o de outra tabela de referencia.
 */
