...
class UpdatePetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'species' => ['sometimes', 'required', 'in:dog,cat,bird,reptile,rodent,fish,other'],
            ...
            // Accountability: optional human-readable justification for the change.
            // Stored on the activity log entry; required when a vet edits third-party pet data? No — UX
            // prompts for it but we never block a save on its absence.
